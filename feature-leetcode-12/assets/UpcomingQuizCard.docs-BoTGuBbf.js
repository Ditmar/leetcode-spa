import{j as e}from"./iframe-PIwxcADB.js";import{useMDXComponents as r}from"./index-QJ6viCUB.js";import"./preload-helper-PPVm8Dsz.js";function t(i){const n={br:"br",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"-upcomingquizcard",children:"🧩 UpcomingQuizCard"}),`
...
`,e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Prop"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Required"}),e.jsx("th",{children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:e.jsx("code",{children:"title"})})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:"✅"}),e.jsx("td",{children:"Title of the quiz or competition."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:e.jsx("code",{children:"date"})})}),e.jsxs("td",{children:[e.jsx("code",{children:"string"})," | ",e.jsx("code",{children:"Date"})]}),e.jsx("td",{children:"✅"}),e.jsxs("td",{children:["Date of the upcoming event. Formatted using the default pattern defined in ",e.jsx("code",{children:"UpcomingQuizCard.constants.ts"}),"."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:e.jsx("code",{children:"description"})})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:"❌"}),e.jsx("td",{children:"Additional text describing the event (optional)."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:e.jsx("code",{children:"onRegister"})})}),e.jsx("td",{children:e.jsx("code",{children:"() => void"})}),e.jsx("td",{children:"✅"}),e.jsxs("td",{children:["Callback executed when the user clicks the ",e.jsx("strong",{children:"Register Now"})," button."]})]})]})]}),`
`,e.jsx(n.hr,{}),`
...
`})})]})}function o(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{o as default};

import{j as s}from"./iframe-BZcnXaOs.js";import{s as o}from"./memoTheme-DvEh67qL.js";import{B as p}from"./Box-BuFBd9lc.js";import{L as f}from"./LinearProgress-0lNeKmGn.js";import{u as M}from"./useTheme-CYf3r9uN.js";import{T as D}from"./Typography-Cu5_uNcf.js";import{C as w}from"./CircularProgress-CaoelgJB.js";var e=(r=>(r.LINEAR="linear",r.CIRCULAR="circular",r))(e||{}),a=(r=>(r.DETERMINATE="determinate",r.INDETERMINATE="indeterminate",r))(a||{});const y=r=>r===void 0?0:Math.min(100,Math.max(0,r)),P=r=>{const n=y(r);return{normalized:n,ariaValueNow:n}},x=o(p)(()=>({width:"100%"})),S=o(p)(({theme:r})=>({fontSize:r.typography.caption.fontSize})),z=o(p)(()=>({display:"flex",justifyContent:"center",alignItems:"center"})),j=o(f)(({theme:r})=>({borderRadius:r.spacing(1),height:r.spacing(1),backgroundColor:r.palette.grey[300]})),k=o(p)(({theme:r})=>({width:"100%",gap:r.spacing(2),padding:r.spacing(2),borderRadius:r.spacing(1.75),border:`1px solid ${r.palette.divider}`,backgroundColor:r.palette.background.paper})),U=o(p)(()=>({display:"flex",justifyContent:"space-between",alignItems:"center",width:"100%"})),_=6,V=4,C=r=>{const{variant:n=e.LINEAR,mode:R=a.DETERMINATE,value:A=60,showLabel:h=!0,color:L="primary",size:v,thickness:N=V}=r,E=M(),T=E.palette[L].main,b=v??E.spacing(_),{normalized:g}=P(A),I=R===a.DETERMINATE;return s.jsxs(k,{children:[s.jsxs(U,{children:[s.jsx(D,{sx:{color:E.palette.text.secondary},children:"Progress"}),h&&I&&n===e.LINEAR&&R===a.DETERMINATE&&s.jsxs(S,{sx:{color:T},children:[g,"%"]})]}),n===e.CIRCULAR?s.jsx(z,{children:s.jsx(w,{variant:I?"determinate":"indeterminate",value:g,size:b,thickness:N,sx:{color:T}})}):s.jsx(x,{children:s.jsx(j,{variant:I?"determinate":"indeterminate",value:g,color:L})})]})};C.__docgenInfo={description:"",methods:[],displayName:"Progress"};const W={title:"component-catalog/Progress",component:C,argTypes:{variant:{control:"select",options:Object.values(e)},mode:{control:"select",options:Object.values(a)},color:{control:"select",options:["primary","secondary","success","error","warning","info","dark"]}}},t={args:{variant:e.LINEAR,mode:a.DETERMINATE,value:60,showLabel:!0,color:"primary"}},i={args:{variant:e.LINEAR,mode:a.INDETERMINATE,showLabel:!1,color:"secondary"}},c={args:{variant:e.CIRCULAR,mode:a.DETERMINATE,value:75,showLabel:!0,color:"success",size:"4rem",thickness:6}},l={args:{variant:e.CIRCULAR,mode:a.INDETERMINATE,showLabel:!1,color:"info",size:"3rem",thickness:4}},d={args:{variant:e.LINEAR,mode:a.DETERMINATE,value:45,showLabel:!0,color:"warning"}},m={args:{variant:e.LINEAR,mode:a.DETERMINATE,value:80,showLabel:!1,color:"error"}},u={args:{variant:e.CIRCULAR,mode:a.DETERMINATE,value:90,showLabel:!0,color:"dark",size:"5rem",thickness:8}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {

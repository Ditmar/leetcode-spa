...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>string</code> | <code>Date</code>
      </td>
      <td>✅</td>
      <td>
        Date of the upcoming event. Formatted using the default pattern defined in{' '}
        <code>UpcomingQuizCard.constants.ts</code>.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>✅</td>
      <td>
        Callback executed when the user clicks the <strong>Register Now</strong> button.
      </td>
    </tr>
  </tbody>
</table>

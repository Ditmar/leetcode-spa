...
describe('MCQQuestion Component', () => {
  ...
  it('renders the question text', () => {
    render(<MCQQuestion question="Sample Question" options={options} onChange={() => {}} />);
  ...
  it('marks the selected option as checked in controlled mode', () => {
    render(<MCQQuestion question="Q" options={options} selectedValue="2" onChange={() => {}} />);
  ...
  it('updates the checked state when selectedValue prop changes', () => {
    ...
    rerender(<MCQQuestion question="Q" options={options} selectedValue="2" onChange={() => {}} />);
  ...
  it('disables all options when disabled prop is true', () => {
    render(
      <MCQQuestion question="Disabled question" options={options} disabled onChange={() => {}} />
    );
  ...
  it('renders the question number when provided', () => {
    render(
      <MCQQuestion number={3} question="Which option?" options={options} onChange={() => {}} />
    );

...
export function useTheme() {
  ...
  return {
    ...
    getColor: (colorKey: ColorKey, shade: ColorShade = 'main') => {
      return (theme.palette as Palette & Record<ColorKey, Record<ColorShade, string>>)[colorKey][
        shade
      ];
    },
    ...
    getSpacing: (...values: number[]) => {
      ...
      return (theme.spacing as any)(...values);
    },
    ...
    mediaQuery: {
      ...
      between: (start: BreakpointKey, end: BreakpointKey) => theme.breakpoints.between(start, end),
    ...
    getInverseColor: (colorKey: ColorKey, shade: ColorShade = 'main') => {
      const color = (theme.palette as Palette & Record<ColorKey, Record<ColorShade, string>>)[
        colorKey
      ][shade];

...
const Collapsible: React.FC<CollapsibleProps> = ({
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      <Box>
        <Typography variant="h5" fontWeight={600}>Collapsible</Typography>
        <Typography variant="body2" color="text.secondary">Expandable content</Typography>
      </Box>

      <S.StyledCard>
        <S.Header>
          {headerSlot || <Typography variant="body2" fontWeight={600}>{title}</Typography>}
          <S.BlackButton 

import{G as W,a as f,V as $,H as V,b as _,j as s,c as O,w as E,x as U,T as P}from"./iframe-RQcz2ruq.js";import{c as B,S as F}from"./createSvgIcon-CvsKA8or.js";import{g as X,a as q,s as u,c as K,m as G}from"./memoTheme-C3zera4y.js";import{B as g}from"./Box-iFnbKbso.js";import{T as A}from"./Typography-X1SEUh0v.js";import{u as Y}from"./useTheme-CPGC3wnd.js";import{g as J}from"./getThemeProps-BhSR698a.js";import{C as I}from"./Card-wG0gWrvF.js";import"./preload-helper-PPVm8Dsz.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./Paper-7RaVMSNR.js";function Z(e,t,o,a,n){const[r,d]=f.useState(()=>n&&o?o(e).matches:a?a(e).matches:t);return V(()=>{if(!o)return;const l=o(e),c=()=>{d(l.matches)};return c(),l.addEventListener("change",c),()=>{l.removeEventListener("change",c)}},[e,o]),r}const ee={...$},Q=ee.useSyncExternalStore;function te(e,t,o,a,n){const r=f.useCallback(()=>t,[t]),d=f.useMemo(()=>{if(n&&o)return()=>o(e).matches;if(a!==null){const{matches:i}=a(e);return()=>i}return r},[r,e,a,n,o]),[l,c]=f.useMemo(()=>{if(o===null)return[r,()=>()=>{}];const i=o(e);return[()=>i.matches,p=>(i.addEventListener("change",p),()=>{i.removeEventListener("change",p)})]},[r,o,e]);return Q(c,l,d)}function H(e={}){const{themeId:t}=e;return function(a,n={}){let r=W();r&&t&&(r=r[t]||r);const d=typeof window<"u"&&typeof window.matchMedia<"u",{defaultMatches:l=!1,matchMedia:c=d?window.matchMedia:null,ssrMatchMedia:h=null,noSsr:i=!1}=J({name:"MuiUseMediaQuery",props:n,theme:r});let p=typeof a=="function"?a(r):a;return p=p.replace(/^@media( ?)/m,""),p.includes("print")&&console.warn(["MUI: You have provided a `print` query to the `useMediaQuery` hook.","Using the print media query to modify print styles can lead to unexpected results.","Consider using the `displayPrint` field in the `sx` prop instead.","More information about `displayPrint` on our docs: https://mui.com/system/display/#display-in-print."].join(`
`)),(Q!==void 0?te:Z)(p,l,c,h,i)}}H();function oe(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function ae(e){return parseFloat(e)}function se(e){return X("MuiSkeleton",e)}q("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const ne=e=>{const{classes:t,variant:o,animation:a,hasChildren:n,width:r,height:d}=e;return K({root:["root",o,a,n&&"withChildren",n&&!r&&"fitContent",n&&!d&&"heightAuto"]},se,t)},k=U`
  0% {
    opacity: 1;
  }
...
}`,...L.parameters?.docs?.source}}};const ze=["Default","Vertical","LongTitle","Loading","SmallLogo","LargeLogo","NoLogo"];export{x as Default,S as LargeLogo,w as Loading,b as LongTitle,L as NoLogo,y as SmallLogo,v as Vertical,ze as __namedExportsOrder,je as default};

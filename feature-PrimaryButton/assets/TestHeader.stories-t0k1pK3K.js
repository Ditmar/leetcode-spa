import{B as $,r as f,V as H,C as V,a as _,j as s,c as O,x as E,y as U,T as B}from"./iframe-DJ9ropZS.js";import{c as P,S as F}from"./createSvgIcon-vpTGL7ud.js";import{s as u}from"./styled-wvmqS4w9.js";import{B as g,T as A}from"./Box-BqN-kd-K.js";import{u as X}from"./useTheme-CKLJGRsg.js";import{g as q,C as I}from"./Card-DPJtvqoK.js";import{g as K,a as Y,c as G,m as J}from"./createSimplePaletteValueFilter-CMt2sp4U.js";import"./preload-helper-PPVm8Dsz.js";import"./Paper-BxvriBX-.js";function Z(e,t,o,a,n){const[r,d]=f.useState(()=>n&&o?o(e).matches:a?a(e).matches:t);return V(()=>{if(!o)return;const l=o(e),c=()=>{d(l.matches)};return c(),l.addEventListener("change",c),()=>{l.removeEventListener("change",c)}},[e,o]),r}const ee={...H},Q=ee.useSyncExternalStore;function te(e,t,o,a,n){const r=f.useCallback(()=>t,[t]),d=f.useMemo(()=>{if(n&&o)return()=>o(e).matches;if(a!==null){const{matches:i}=a(e);return()=>i}return r},[r,e,a,n,o]),[l,c]=f.useMemo(()=>{if(o===null)return[r,()=>()=>{}];const i=o(e);return[()=>i.matches,p=>(i.addEventListener("change",p),()=>{i.removeEventListener("change",p)})]},[r,o,e]);return Q(c,l,d)}function N(e={}){const{themeId:t}=e;return function(a,n={}){let r=$();r&&t&&(r=r[t]||r);const d=typeof window<"u"&&typeof window.matchMedia<"u",{defaultMatches:l=!1,matchMedia:c=d?window.matchMedia:null,ssrMatchMedia:h=null,noSsr:i=!1}=q({name:"MuiUseMediaQuery",props:n,theme:r});let p=typeof a=="function"?a(r):a;return p=p.replace(/^@media( ?)/m,""),p.includes("print")&&console.warn(["MUI: You have provided a `print` query to the `useMediaQuery` hook.","Using the print media query to modify print styles can lead to unexpected results.","Consider using the `displayPrint` field in the `sx` prop instead.","More information about `displayPrint` on our docs: https://mui.com/system/display/#display-in-print."].join(`
`)),(Q!==void 0?te:Z)(p,l,c,h,i)}}N();function oe(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function ae(e){return parseFloat(e)}function se(e){return K("MuiSkeleton",e)}Y("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const ne=e=>{const{classes:t,variant:o,animation:a,hasChildren:n,width:r,height:d}=e;return G({root:["root",o,a,n&&"withChildren",n&&!r&&"fitContent",n&&!d&&"heightAuto"]},se,t)},k=U`
  0% {
    opacity: 1;
  }
...
}`,...L.parameters?.docs?.source}}};const ke=["Default","Vertical","LongTitle","Loading","SmallLogo","LargeLogo","NoLogo"];export{x as Default,S as LargeLogo,w as Loading,b as LongTitle,L as NoLogo,y as SmallLogo,v as Vertical,ke as __namedExportsOrder,Te as default};

...
}`,...j.parameters?.docs?.source}}};const zr=["Numeric","MaxOverflow","DotVariant","ColorVariants","TopLeft","TopRight","BottomLeft","BottomRight","PositionExamples","Playground"],Ir=Object.freeze(Object.defineProperty({__proto__:null,BottomLeft:B,BottomRight:O,ColorVariants:b,DotVariant:x,MaxOverflow:u,Numeric:f,Playground:j,PositionExamples:C,TopLeft:v,TopRight:y,__namedExportsOrder:zr,default:Tr},Symbol.toStringTag,{value:"Module"}));export{Ir as B,f as N,C as P};
